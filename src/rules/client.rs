    ...
    fn check(&self, analysis: &FileAnalysis) -> Vec<Diagnostic> {
        analysis
            ...
            .map(|h| Diagnostic {
                ...
                message: "`useMutation` call may execute in render body".to_string(),
                help: "Calling mutations during render causes infinite write loops. Call the mutate function inside event handlers or useEffect.".to_string(),
